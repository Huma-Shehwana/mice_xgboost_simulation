...
All_param_set_maxit5 <- missing_MAR_list %>%
  map(function(mat_list) { 
    furrr::future_map(mat_list, function(mat) {
      result <- system.time({
        params <- xgb_param_calc_g1(mat,response = "all", select_features=NULL, iter = 50)
      })
...
save(hyperParameters, file = "ParameterOptimization/hyperparameters_iter50.RData")
save(mice_results, file = "ParameterOptimization/mice_results_iter50.RData")
save(eval, file = "ParameterOptimization/eval_iter50.RData")
save(eval_linear, file = "ParameterOptimization/eval_linear_iter50.RData")

train_testplot(simdata, mice_results,prop_values, "ParameterOptimization/TT_xgb_ParamDefault_maxit5_PO_imp_res.pdf")
...
save(hyperParameters_100, file = "ParameterOptimization/hyperparameters_iter100.RData")
save(mice_results_100, file = "ParameterOptimization/mice_results_iter100.RData")
save(eval_100, file = "ParameterOptimization/eval_iter100.RData")
save(eval_linear_100, file = "ParameterOptimization/eval_linear_iter100.RData")

train_testplot(simdata, mice_results_100,prop_values, "ParameterOptimization/TT_xgb_AllParam_maxit5_PO_imp_res_100.pdf")
...
save(hyperParameters_150, file = "ParameterOptimization/hyperparameters_iter150.RData")
save(mice_results_150, file = "ParameterOptimization/mice_results_iter150.RData")
save(eval_150, file = "ParameterOptimization/eval_iter150.RData")
save(eval_linear_150, file = "ParameterOptimization/eval_linear_iter150.RData")

train_testplot(simdata, mice_results_150,prop_values, "ParameterOptimization/TT_xgb_AllParam_maxit5_PO_imp_res_150.pdf")
...
save(hyperParameters_200, file = "ParameterOptimization/hyperparameters_iter200.RData")
save(mice_results_200, file = "ParameterOptimization/mice_results_iter200.RData")
save(eval_200, file = "ParameterOptimization/eval_iter200.RData")
save(eval_linear_200, file = "ParameterOptimization/eval_linear_iter200.RData")

train_testplot(simdata, mice_results_200,prop_values, "ParameterOptimization/TT_xgb_AllParam_maxit5_PO_imp_res_200.pdf")
