...
save(mixgb_maxit1_pmmNULL_imp, file = "results/mixgb_maxit1_pmmNULL_imp.RData") # save imputation results
save(mixgb_maxit1_pmmNULL_time, file = "results/mixgb_maxit1_pmmNULL_time.RData") # save time taken for imputation results
save(mixgb_maxit1_pmmNULL_eval, file = "results/mixgb_maxit1_pmmNULL_eval.RData") # save regression results fitted on imputed data
...
save(mixgb_maxit1_pmm1_imp, file = "results/mixgb_maxit1_pmm1_imp.RData") # save imputation results
save(mixgb_maxit1_pmm1_time, file = "results/mixgb_maxit1_pmm1_time.RData") # save time taken for imputation results
save(mixgb_maxit1_pmm1_eval, file = "results/mixgb_maxit1_pmm1_eval.RData") # save regression results fitted on imputed data
...
save(mixgb_maxit1_pmm2_imp, file = "results/mixgb_maxit1_pmm2_imp.RData") # save imputation results
save(mixgb_maxit1_pmm2_time, file = "results/mixgb_maxit1_pmm2_time.RData") # save time taken for imputation results
save(mixgb_maxit1_pmm2_eval, file = "results/mixgb_maxit1_pmm2_eval.RData") # save regression results fitted on imputed data
